  ...
  return (
    <>
      ...
      <motion.button
        ...
        className="absolute lg:fixed z-40 w-14 h-14 sm:w-20 sm:h-20 rounded-full bg-gradient-to-br from-purple-500 to-indigo-600 text-white shadow-lg hover:shadow-xl hover:scale-110 transition-all duration-200 flex items-center justify-center group bottom-[13rem] lg:bottom-[3rem] right-[2.5rem]"
