  ...
  return (
    <>
      ...
      <motion.button
        ...
        className="fixed bottom-[100px] right-10 z-40 w-24 h-24 rounded-full bg-gradient-to-br from-purple-500 to-indigo-600 text-white shadow-lg hover:shadow-xl hover:scale-110 transition-all duration-200 flex items-center justify-center group"
