...
export default function WordCloud() {
  ...
  return (
    <div className="relative h-full w-full flex flex-col items-center justify-start mt-6 md:mt-16 lg:mt-20 overflow-visible">
      ...
      <motion.div
        className="text-4xl sm:text-4xl md:text-6xl lg:text-8xl font-black bg-gradient-to-r from-pink-500 via-purple-500 to-blue-500 dark:from-pink-400 dark:via-purple-400 dark:to-blue-400 text-transparent bg-clip-text mt-[110px] lg:mt-[140px]"
