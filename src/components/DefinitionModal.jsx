  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        {/* Modal Content */}
        <motion.div
          className="relative bg-gradient-to-br from-white via-purple-50 to-blue-50 dark:from-gray-800 dark:via-gray-900 dark:to-gray-800 rounded-3xl shadow-2xl max-w-2xl w-full max-h-[80vh] overflow-y-auto"
          ...
          <div className="p-8">
            ...
            {isLoading && (
              <div className="flex flex-col items-center justify-center py-12">
                <div className="animate-spin rounded-full h-12 w-12 border-4 border-purple-500 dark:border-purple-400 border-t-transparent"></div>
                <p className="text-slate-600 dark:text-gray-300 mt-4">Loading definition...</p>
              </div>
            )}
